...
First, we will conduct the following event study.

### Dynamic Liner Panel Model (Table.2)

Next, we will estimate the following dynamic linear panel model.
\begin{align*}
...
Finally, we will perform the instrumental variable method. The instrumental variables used in this analysis are as follows.
\begin{align*}
...
## Arellano Bond Estimation for Table.2
